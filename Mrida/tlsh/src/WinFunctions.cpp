...
DIR *opendir(const char *dirname)
{
	...
	_snprintf_s(dir->dirname, sizeof(dir->dirname), "%s\\*", dirname);
	return dir;
}
...
struct dirent *readdir(DIR *dir)
{
	...
	_snprintf_s(dir->findDirEnt.d_name, sizeof(dir->findDirEnt.d_name), "%s", dir->findFileData.cFileName);
